...
const Pagination = ({ pageFunction, current }) => {
  ...
  return (
    <div className="flex items-center justify-center mt-8">
      ...
      <h3 className="bg-slate-300 font-bold dark:bg-zinc-700 text-slate-800 dark:text-slate-300 p-3 border-l border-r dark:border-slate-500 border-slate-400 transition-colors duration-500">
        Page {current}
      </h3>
      <button
