  ...
  return (
    <div className="flex w-full text-center text-xl">
      <div className="w-full relative">
        ...
        />
        <button className="absolute text-slate-400 bottom-[20%] left-[80%] transition duration-300 ease-in-out hover:transition-all dark:hover:text-white hover:text-slate-600">
